...
## 👋 Welcome
Welcome to my **Infrastructure as Code (IaC)** portfolio repository.

This space showcases my hands-on journey in designing, provisioning, and managing cloud infrastructure using **Terraform on Amazon Web Services (AWS)**.
...
- Deepening Terraform Expertise: Writing cleaner, efficient, scalable configurations
- Cloud Architecture Understanding: Designing reliable & cost-effective AWS solutions
- Automation Mindset: Reducing manual effort through automation
- Problem-Solving Skills: Debugging and optimizing infrastructure
- Consistency & Documentation: Maintaining professional, well-documented projects
...
⭐ Built with passion, consistency, and Terraform by **Nagesh Jaybhaye**
